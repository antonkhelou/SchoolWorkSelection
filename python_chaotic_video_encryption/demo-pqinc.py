...
def encrypt_video_file_cat_map_stream_max_fit(rounds, p, q, write_file, grayscale, path_to_video_file=None):
	...
	print "Press N or M to decrease/increase q value"
	print "Press < or > to decrease/increase p value"
...
if __name__ == "__main__":
    encrypt_video_file_cat_map_stream_max_fit(1, 0, 0, write_file=False, grayscale=False)
